...
def sample_docs():
    return [
        {
            "id": "doc1",
            "text": "Hybrid RAG combines dense and sparse retrieval.",
            "score": 0.92,
        },
        {
            "id": "doc2",
            "text": "BM25 is a classic sparse retrieval algorithm.",
            "score": 0.85,
        },
        {
            "id": "doc3",
            "text": "FAISS enables fast approximate nearest-neighbour search.",
            "score": 0.81,
        },
        {
            "id": "doc4",
            "text": "Reranking improves precision of top-k results.",
            "score": 0.78,
        },
        {
            "id": "doc5",
            "text": "Metadata filters narrow the candidate pool.",
            "score": 0.70,
        },
    ]
